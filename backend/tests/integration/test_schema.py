...
API_TABLE_PRIVILEGES = {
    ...
    "social_oauth_ceremonies": {"SELECT", "INSERT", "UPDATE"},
    "social_accounts": {"SELECT", "INSERT", "UPDATE"},
    "oauth_grants": {"SELECT", "INSERT", "UPDATE"},
    "publication_batches": {"SELECT", "INSERT"},
    "publications": {"SELECT", "INSERT", "UPDATE"},
...
WORKER_TABLE_PRIVILEGES = {
    ...
    "social_accounts": {"SELECT", "UPDATE"},
    "oauth_grants": {"SELECT", "UPDATE"},
    "publication_batches": {"SELECT"},
...
EXPECTED_ENUMS = {
    ...
    "social_provider": ("youtube", "instagram", "tiktok"),
    "social_connection_status": ("active", "reconnect_required", "revoked"),
    "publication_status": (
        "draft",
        "awaiting_approval",
        "scheduled",
