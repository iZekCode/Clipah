...
The database fixtures live here so contract and integration modules can share
them. They stay opt-in: a test that never requests one never touches Postgres.
"""
